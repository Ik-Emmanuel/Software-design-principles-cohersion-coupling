"""
Seperating code for higher cohesion and loose coupling
"""
...
class VehicleRegistry:
    ...
    def __init__(self):
        #ideally this will be read from a database that has been pre populated with vehicles and their info
        # but this just calls this method upon initialization to fill the vehicle_info with a few brands 
        self.vehicle_info = { }
